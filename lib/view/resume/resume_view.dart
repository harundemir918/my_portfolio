...
class _ResumeViewState extends State<ResumeView> {
  ...
  Container _resumeCardTopSection() => Container(
  ...
  Widget _resumeCardTitle() => Padding(
  ...
  Container _resumeCardBottomSection() => Container(
  ...
  Widget _resumeCardInfoTitle(String title) => Text(
        title,
  ...
  Widget _resumeCardInfoEducation() => Column(
  ...
  Widget _resumeCardInfoExperience() => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  Widget _resumeListCard(ResumeModel resumeModel) => Container(
  ...
  Padding _resumeListCardTitle(ResumeModel resumeModel) => Padding(
  ...
  Padding _resumeListCardDescription(ResumeModel resumeModel) => Padding(
        padding: const EdgeInsets.symmetric(vertical: kDefaultPadding / 2),
        child: Text(
  ...
  Padding _resumeListCardDetails(ResumeModel resumeModel) => Padding(
        padding: const EdgeInsets.symmetric(vertical: kDefaultPadding / 2),
        child: responsive_framework.ResponsiveRowColumn(
