...
class _AboutViewState extends State<AboutView> {
  ...
  Wrap _aboutCardBody(BuildContext context) => Wrap(
        children: [
  ...
  Container _aboutCardTopSection(BuildContext context) => Container(
  ...
  ClipRRect _aboutCardImage(BuildContext context) => ClipRRect(
  ...
  Widget _aboutCardTitle(BuildContext context) => Padding(
  ...
  Widget _aboutCardDescription(BuildContext context) => const TypeWriterText();

  Widget _aboutCardContactOptions(BuildContext context) => Row(
  ...
  Container _aboutCardBottomSection(BuildContext context) => Container(
  ...
  Widget _aboutCardInfoTop(BuildContext context) => Column(
  ...
  Widget _aboutCardInfoTitle(BuildContext context) => Text(
        "About",
  ...
  Padding _aboutCardInfoSummary() => const Padding(
  ...
  Widget _aboutCardInfoBottom(BuildContext context) => Column(
        children: [
