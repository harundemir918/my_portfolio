...
class PortfolioDetailView extends StatelessWidget {
  ...
  Widget _portfolioDetailTitle(BuildContext context, String title) {
    return Text(
      title,
  ...
  Container _portfolioDetailProjectSection(BuildContext context) {
    return Container(
  ...
  SizedBox _portfolioDetailSlider(BuildContext context) {
    return SizedBox(
  ...
  SizedBox _portfolioDetailSliderCard({required String image}) {
    return SizedBox(
      child: Image.network(
        image,
  ...
  Padding _portfolioDetailProjectInfo(BuildContext context) {
    return Padding(
  ...
  Column _portfolioDetailTechStackCard(BuildContext context) {
    return Column(
  ...
  Column _portfolioDetailDescriptionCard(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
