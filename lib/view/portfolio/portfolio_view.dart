...
class _PortfolioViewState extends State<PortfolioView> {
  ...
  Container _portfolioCardTopSection() => Container(
  ...
  Widget _portfolioCardTitle() => Padding(
  ...
  Container _portfolioCardBottomSection() => Container(
  ...
  TextButton _portfolioProjectListCard({required String image}) => TextButton(
